...
class PromotionAdmin extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        if($model->save()){
            ...
            return redirect('admin/promotion')->with($complete);
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        if($model::where('id', $post['hd_id'])->update($info)){
            ...
            // $path_url = public_path($post['hd_upload'].'/promotion/'.$post['hd_id']);
            // $path_save = 'upload/promotion'; //path รูปภาพสำหรับบันทึกลง db
