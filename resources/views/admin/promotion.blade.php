...
<main class="main-content position-relative border-radius-lg">
    <div class="container-fluid mt-6rem">
        <div class="row nav-fixed">
            <div class="col-6">
                <Strong class="">รายการข้อมูลโปรโมชั่น</Strong>
            </div>
            <div class="col-6 text-end">
                <a href="{{ route('admin.pmtnew') }}" class="btn btn-primary m-0">ใหม่</a>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ route('admin.pmtedit', $item->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                Edit
                                            </a>
                                        </td>
                                    </tr>
