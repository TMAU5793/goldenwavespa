				...
				<ul>
					...
					<li data-index="rs-1" data-transition="zoomout">
						...
						<div class="tp-caption" 
							...
							<span class="sub-title">Golden Wave Spa โอเอซิสกลางกรุง เจริญกรุง 77</span>
						</div>
						...
						<div class="tp-caption" 
							...
							data-textalign="['top','top','top','top']"
							data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'>
							<h1 class="title">สวยครบครัน <br> ปังครบสูตร</h1>
						</div>
						...
						<div class="tp-caption" 
							...
							data-textalign="['top','top','top','top']"
							data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'>
							<div class="text">ครบครันเรื่องความงาม ไม่ต้องเสียเวลาหาที่อื่น เรามีบริการซาลอนครบวงจร <br>นวดหน้า นวดศรีษะแบบอินเดีย ทำเล็บและต่อขนตา</div>
						</div>
					...
					{{-- <li data-index="rs-2" data-transition="zoomout">
						...
						<div class="tp-caption" 
							...
							data-textalign="['top','top','top','top']"
							data-frames='[{"delay":1100,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'>
							<figure class="image"><img src="{{ url('assets/images/main-slider/slide2-3.png') }}" alt="Image"></figure>
						</div>
						...
						<div class="tp-caption" 
							...
							data-textalign="['top','top','top','top']"
							data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'>
							<div class="text">Proin efficitur, mauris vel condimentum pulvinar, velit orci consectetur ligula, eget egestas magna mi ut arcu. Phasellus nec odio orci. Nunc id massa ante.</div>
						</div>
		...
		<div class="auto-container">
			<div class="outer-box">
				<div class="sec-title text-center">
					...
					<h2 class="words-slide-up text-split">Our Services</h2>
				</div>
				<div class="row">
					...
					<div class="image-column col-lg-6">
						<div class="inner-column">
							<div class="image-box">
								...
								<div class="row g-0">
									<div class="col-sm-6">
										<figure class="image-one mb-0"><a href="page-about.html"><img src="{{ url('assets/images/home-building1.jpg') }}" alt="Image"></a></figure>
									</div>
									<div class="col-sm-6">
										<figure class="image-two"><a href="page-about.html"><img src="{{ url('assets/images/home-building2.jpg') }}" alt="Image"></a></figure>
										<figure class="image-two mb-0"><a href="page-about.html"><img src="{{ url('assets/images/home-building3.jpg') }}" alt="Image"></a></figure>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="content-column col-lg-6">
						<div class="inner-column">
							<div class="sec-title mb-0">
								...
								<h2 class="words-slide-up">Building Physically & mental Health</h2>
								<div class="text">Proin efficitur, mauris vel condimentum pulvinar, velit orci consectetur ligula, eget egestas magna mi ut arcu. Phasellus nec odio orci. Nunc id massa ante. Proin efficitur, mauris vel condimentum pulvinar, velit orci consectetur .</div>
							</div>
							<div class="row">
								<div class="list-box col-sm-4">
									<div class="inner">
										<figure class="thumb"><img src="{{ url('assets/images/resource/about2-4.png') }}" alt="Image"></figure>
										<h4 class="title">Nail Care</h4>
									</div>
								</div>
								<div class="list-box col-sm-4">
									<div class="inner">
										<figure class="thumb"><img src="{{ url('assets/images/resource/about-facial.png') }}" alt="Image"></figure>
										<h4 class="title">Facial Tretments</h4>
									</div>
								</div>
								<div class="list-box col-sm-4">
									<div class="inner">
										<figure class="thumb"><img src="{{ url('assets/images/resource/about-hair.png') }}" alt="Image"></figure>
										<h4 class="title">Hair Salon</h4>
									</div>
								</div>
							</div>
							<div class="author-box">
								<div class="inner">
									<a href="{{ route('services') }}" class="theme-btn btn-style-two btn pricing-btn"><span class="btn-title">Know More</span></a>
				...
				<div class="col-xl-6 offset-xl-6">
					<div class="outer-box">
						<div class="sec-title mb-0 text-center">
							<h1 class="words-slide-up text-split">Offer Of The Day</h1>
							<span class="text-two">35% off on Selected Products</span>
							<div class="text">Proin efficitur, mauris vel condimentum pulvinar, velit orci consectetur ligula, eget egestas magna mi ut arcu.</div>
							<span class="text-three">Hurry up! Deals end up :</span>
						</div>
						<div class="countdown-block-outer">
							<div class="countdown-block">
								<div class="inner-box">                            
									<div class="content-box">
										<div class="countdown-time">350</div>
							...
							<div class="countdown-block">
								<div class="inner-box">                            
									<div class="content-box">
										<div class="countdown-time">30</div>
							...
							<div class="countdown-block">
								<div class="inner-box">                            
									<div class="content-box">
										...
										<div class="countdown-title">Mints</div>
									</div>
								</div>
							</div>
							<div class="countdown-block">
